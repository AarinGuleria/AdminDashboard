...
export const authProvider: AuthBindings = {
  ...
  onError: async (error) => {
    // a check to see if the error is an authorization error
  ...
  check: async () => {
    try {
        ...
        // this is to know if the user os authoricated or not
  ...
  getIdentity: async () => {
    ...
    try {
        ...
        // we're using me:any because theGraphQL API doesnt have a type for the me query yet.
      ...
      const { data } = await dataProvider.custom<{ me: any }>({
        ...
        headers: accessToken
          ...
          : {},
        meta: {
            // get the user information such as the name , email, etc.
          rawQuery: `
                    query Me {
                        me {
                            id,
