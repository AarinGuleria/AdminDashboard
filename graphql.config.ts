      ...
      generates: {
        ...
        "src/graphql/schema.types.ts": {
          ...
          config: {
            ...
            scalars: {
              // DateTime is a scalar type that is used to repesent date and time
              DateTime: {
                input: "string",
                output: "string",
                format: "date-time",
        ...
        "src/graphql/types.ts": {
          ...
          preset: "import-types",
          // documents is used to define the path of the files that contain GraphQl operatioins
          ...
          config: {
            ...
            // When preResolveTypes is set to false, the code generator will not try to resolve the type ahead of time.
            // Instead, it will generate more generic types, and the actual types will be resolved at runtime.
            preResolveTypes: false,
            // useType Imports is used to import types using import type instead of import.
            useTypeImports: true,
          },
